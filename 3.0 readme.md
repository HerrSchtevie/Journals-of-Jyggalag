...
For reference, I run this list on a 32:9 ultrawide monitor (5120 x 1440) with smooth, consistent FPS on the Lord's Vsiion profile.
...
- **You must have the Creation Kit installed via Steam.**  
  ...
  > Example: If Skyrim AE is installed on `C:\`, the Creation Kit must also be installed on `C:\`.
...
2. **Prepare a Clean Skyrim AE Installation**  
   ...
   - Install the **Creation Kit** from the *Tools* section in your Steam Library.  
     ✅ Make sure it’s installed on the **same drive** as Skyrim AE.
   - **Launch the Creation Kit once** to initialize its content, then close it.
...
4. **Select the Modlist**
   ...
   - Choose:
     - A **Download Location** – where Wabbajack will store mod archives (can be any drive).
     - An **Installation Location** – where the modlist will be installed.  
       ⚠️ **This must be on an SSD**.
...
- 🧰 Did you install the **Creation Kit** via Steam on the **same drive** as your Skyrim install?
- 🟢 Did you **launch the Creation Kit once** to initialize its required files?
...
> If you’ve gone through the full checklist and are still stuck, feel free to ask for help in the **Journals of Jyggalag Discord**:  
> 🔗 [https://discord.gg/WuJe7CXpCZ](https://discord.gg/WuJe7CXpCZ)
